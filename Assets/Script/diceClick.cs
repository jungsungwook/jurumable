...
public class diceClick : MonoBehaviour
{
    ...
    public void asd()
    {
        ...
        GameObject.Find("Canvas").transform.FindChild(teamList[tnstj].name + "team").transform.position = GameObject.Find("Canvas").transform.FindChild("background").
            transform.FindChild(teamList[tnstj].locate + "").transform.FindChild(teamList[tnstj].name + "pos").transform.position;
        switch (teamList[tnstj].locate)
        {
            ...
            case 3:
                ...
                GameObject.Find("Canvas").transform.FindChild("bad").transform.FindChild("Text").GetComponent<Text>().text = bad[Random.Range(0, bad.Count)];
                GameObject.Find("Canvas").transform.FindChild("baddefend").gameObject.SetActive(true);
                break;
            case 4:
                break;
            case 5:
            ...
            case 10:
                GameObject.Find("Canvas").transform.FindChild("bad").gameObject.SetActive(true);
                GameObject.Find("Canvas").transform.FindChild("bad").transform.FindChild("Text").GetComponent<Text>().text = "소주" + stacksoju + "잔 마시기";
                GameObject.Find("Canvas").transform.FindChild("baddefend").gameObject.SetActive(true);
                stacksoju = 0;
                break;
            case 11:
                GameObject.Find("Canvas").transform.FindChild("good").gameObject.SetActive(true);
                GameObject.Find("Canvas").transform.FindChild("good").transform.FindChild("Text").GetComponent<Text>().text = good[Random.Range(0, good.Count)];
                GameObject.Find("Canvas").transform.FindChild("gooddefend").gameObject.SetActive(true);
                break;
            case 12:
                GameObject.Find("Canvas").transform.FindChild("bad").gameObject.SetActive(true);
                GameObject.Find("Canvas").transform.FindChild("bad").transform.FindChild("Text").GetComponent<Text>().text = bad[Random.Range(0, bad.Count)];
    ...
    public void badcardClick()
    {
        ...
        GameObject.Find("Canvas").transform.FindChild("baddefend").gameObject.SetActive(false);
    }
    public void goodcardClick()
    {
        GameObject.Find("Canvas").transform.FindChild("good").gameObject.SetActive(false);
        GameObject.Find("Canvas").transform.FindChild("gooddefend").gameObject.SetActive(false);
    }
}
